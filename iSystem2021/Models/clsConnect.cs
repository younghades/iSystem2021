...
namespace slnSpaMsVy.Models
{
    public class clsConnect
    {
        ...
        public clsConnect()
        {
            connectionstring = ConfigurationManager.ConnectionStrings["dbiSystem2021"].ConnectionString;
        ...
        {
            string query = @"DELETE FROM " + Table.Trim() + " WHERE " + Where+ ";";
            cmd = new SqlCommand(query, cnn);
            return cmd.ExecuteNonQuery();
        }
